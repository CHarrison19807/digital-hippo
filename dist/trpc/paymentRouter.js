...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_2.privateProcedure
        .input(zod_1.z.object({ productIds: zod_1.z.array(zod_1.z.number()) }))
    ...
    pollOrderStatus: trpc_1.publicProcedure
        .input(zod_1.z.object({ orderId: zod_1.z.number() }))
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var payload, orderId, orders, order;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, getPayload_1.default)()];
                    case 1:
                        payload = _b.sent();
