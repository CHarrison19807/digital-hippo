...
var getPayload_1 = __importDefault(require("./getPayload"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, getPayload_1.default)({
                            initOptions: {
                                express: app,
                ...
                case 1:
                    ...
                    app.use("/api/trpc", trpcExpress.createExpressMiddleware({ router: index_1.appRouter, createContext: createContext }));
                    app.use(function (req, res) { return (0, nextUtils_1.nextHandler)(req, res); });
                    return [4 /*yield*/, nextUtils_1.nextApp.prepare()];
                case 2:
                    _a.sent();
                    payload.logger.info("Next.js started");
                    app.listen(PORT, function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("Express started on port ".concat(PORT));
                            return [2 /*return*/];
                        });
                    }); });
                    return [2 /*return*/];
